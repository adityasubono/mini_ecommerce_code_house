...
@section('content-wrapper')
    <div class="content-wrapper">
        ...
        <div class="card card-primary">
            ...
            <!-- /.card-header -->
            <!-- form start -->
            <form role="form" action="/seller/product-update/{{$product->id}}" method="post" enctype="multipart/form-data">
                @csrf
                @method('patch')
                <div class="card-body">
                    <div class="row">
                        <div class="col-md-6">
                                ...
                                <select name="category"
                                    ...
                                    @foreach($category as $data)
                                        @if($product->category_id == $data->id )
                                            <option value="{{$product->category_id}}" selected="selected">{{$data->name}}</option>
                                        @else
                            ...
                            <div class="form-group">
                                ...
                                <textarea class="form-control @error('info_product') is-invalid @enderror"
                                          ...
                                          id="info_product"
                                          name="info_product"
                                          placeholder="Enter ...">{{$product->info_product}}</textarea>
                                @error('category')
                                <span class="invalid-feedback" role="alert">
                                    <strong>{{ $message }}</strong>
                                </span>
                            ...
                            <div class="form-group">
                                <label for="benefits">Benefit Products</label>
                                <textarea class="form-control @error('benefit') is-invalid @enderror"
                                          rows="3"
                                          id="benefits"
                                          name="benefits"
                                          placeholder="Enter ...">{{$product->benefits}}</textarea>
                                @error('benefit')
                                <span class="invalid-feedback" role="alert">
                                    <strong>{{ $message }}</strong>
                                </span>
                            ...
                            <div class="form-group">
                                ...
                                <textarea class="form-control @error('storage') is-invalid @enderror"
                                          ...
                                          id="storage"
                                          name="storage"
                                          placeholder="Enter ...">{{$product->storage}}</textarea>
                                @error('storage')
                                <span class="invalid-feedback" role="alert">
                                    <strong>{{ $message }}</strong>
                                </span>
