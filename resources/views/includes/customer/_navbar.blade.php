    ...
    <div class="container">
        ...
        <div class="collapse navbar-collapse" id="ftco-nav">
            <ul class="navbar-nav ml-auto">
                ...
                <li class="nav-item active">
                    <a href="{{ route('login') }}" class="nav-link" data-toggle="modal" data-target="#login">{{ __('Login') }}</a>
                </li>
                <li class="nav-item active">
                    <a href="{{ route('login') }}" class="nav-link" data-toggle="modal" data-target="#register">{{ __('Register') }}</a>
                </li>
        ...
        <div class="collapse navbar-collapse" id="ftco-nav">
            <ul class="navbar-nav ml-auto">
                ...
                <li class="nav-item dropdown">
                    <a class="nav-link dropdown-toggle" href="#" id="dropdown04" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false"><b>{{ Auth::user()->name }}</b></a>
